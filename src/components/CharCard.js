      ...
      <div className="character">
        ...
        <div className="char-middle">
          <div className="char-left">
            <div data-tip="Your Helm" data-type="info" className="helm char-item"></div>
            <div data-tip="Your Boots" data-type="info" className="boots char-item"></div>
            <div data-tip="Your Exp" data-type="info" className="exp">exp</div>
          </div>

          <div data-tip="Its you - a handsome UFO )))" data-type="info" className="icon"></div>

          <div className="char-right">
            <div data-tip="Your Armor" data-type="info" className="armor char-item"></div>
            <div data-tip="Your Gloves" data-type="info" className="gloves char-item"></div>
            <div data-tip="Char HP" data-type="info" className="hp">100</div>
          </div>
        </div>

        <div className="char-bottom">
          <div data-tip="Your Weapon" data-type="info" className="weapon"></div>
