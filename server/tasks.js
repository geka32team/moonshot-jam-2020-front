...
function level_4_challenge(level) {
  ...
  return brackets_randomizer ? [`(${a_mod} ${sign1} ${b_mod}) ${sign2} ${c_mod} = ${d}`, x + ""] : [`${a_mod} ${sign1} (${b_mod} ${sign2} ${c_mod}) = ${d}`, x + ""];
}

exports.difficulty = [level_1_challenge, level_2_challenge, level_3_challenge, level_4_challenge];
